...
$(document).ready(() => {
  ...
  const madeSimpleAnimations = new Waypoint({
    element: document.getElementsByClassName('madeSimpleInfo')[0],
    handler: () => {
  ...
  const howItWorksAnimations = new Waypoint({
    element: document.getElementsByClassName('howItWorksInfo')[0],
    handler: () => {
  ...
  const whatWereAboutHeaderAnimations = new Waypoint({
    element: document.getElementsByClassName('whatWereAboutHeader')[0],
    handler: () => {
  ...
  const teamRowFourAnimation = new Waypoint({
  ...
  const teamTextBottomAnimation = new Waypoint({
    element: document.getElementsByClassName('teamTextBottom')[0],
    handler: () => {
  ...
  const registrationPageAnimations = new Waypoint({
