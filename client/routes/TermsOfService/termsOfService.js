  ...
  <div className="infowrapper">
    ...
    <div className="content">
      ...
      <div className="text-content">
        <h4>OVERVIEW</h4>
        <p className="para-terms">This website is operated by BarterOut. Throughout the site,
        the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to BarterOut.
        BarterOut offers this website, including all information, tools and services available
        from this site to you, the user, conditioned upon your acceptance of all terms,
        conditions, policies and notices stated here. By visiting our site and/ or purchasing
        something from us, you engage in our &ldquo;Service&rdquo; and agree to be bound by
        the following terms and conditions (&ldquo;Terms of Service&rdquo;, &ldquo;Terms&rdquo;),
        ...
        contributors of content. Please read these Terms of Service carefully before accessing
        or using our website. By accessing or using any part of the site, you agree to be bound
        ...
        <p className="para-terms">
          ...
          of majority in your state or province of residence, or that you are the age of majority
          in your state or province of residence and you have given us your consent to allow any
          of your minor dependents to use this site. You may not use our products for any illegal
          or unauthorized purpose nor may you, in the use of the Service, violate any laws in
          your jurisdiction (including but not limited to copyright laws). You must not transmit
          any worms or viruses or any code of a destructive nature. A breach or violation of any
        ...
        <p className="para-terms">
          ...
          information is always encrypted during transfer over networks. You agree not to reproduce,
          duplicate, copy, sell, resell or exploit any portion of the Service, use of the Service,
          or access to the Service or any contact on the website through which the service is
          provided, without express written permission by us. The headings used in this agreement
        ...
        <p className="para-terms">
          ...
          distributors. You agree to provide current, complete and accurate purchase and
          ...
          transactions and contact you as needed. For more detail, please review our Returns Policy.
        </p>
        <p className="para-terms">
          ...
          tools &rdquo;as is&rdquo; and &ldquo;as available&rdquo; without any warranties,
          ...
          future, offer new services and/or features through the website (including, the release
          of new tools and resources). Such new features and/or services shall also be subject
        ...
        <p className="para-terms">
          ...
          products, or services of third-parties. We are not liable for any harm or damages
          related to the purchase or use of goods, services, resources, content, or any other
          transactions made in connection with any third-party websites. Please review carefully
          the third-party&apos;s policies and practices and make sure you understand them before
        ...
        <p className="para-terms">
          ...
          pornographic, obscene or otherwise objectionable or violates any party&rsquo;s
          intellectual property or these Terms of Service. You agree that your comments will not
          violate any right of any third-party, including copyright, trademark, privacy, personality
          or other personal or proprietary right. You further agree that your comments will not
          contain libelous or otherwise unlawful, abusive or obscene material, or contain any
          computer virus or other malware that could in any way affect the operation of the Service
          or any related website. You may not use a false e-mail address, pretend to be someone
          other than yourself, or otherwise mislead us or third- parties as to the origin of any
          comments. You are solely responsible for any comments you make and their accuracy. We
        ...
        <p className="para-terms">
          ...
          or update information or cancel orders if any information in the Service or on any
        ...
        <p className="para-terms">
          ...
          stated by us) provided &apos;as is&apos; and &apos;as available&apos; for
          your use, without any representation, warranties or conditions of any kind,
          ...
          durability, title, and non-infringement. In no case shall BarterOut, our
          ...
          in any way to your use of the service or any product, including, but not limited
        ...
        <p className="para-terms">
          ...
          <br />
          You agree to indemnify, defend and hold harmless BarterOut and our parent,
          ...
          harmless from any claim or demand, including reasonable attorneys&rsquo; fees,
          made by any third-party due to or arising out of your breach of these Terms of
        ...
        <p className="para-terms">
          ...
          unlawful, void or unenforceable, such provision shall nonetheless be enforceabl
        ...
        <p className="para-terms">
          ...
          provision of these Terms of Service, we also may terminate this agreement at any
          time without notice and you will remain liable for all amounts due up to and
        ...
        <p className="para-terms">
          ...
          to, any prior versions of the Terms of Service). Any ambiguities in the interpretation of
          these Terms of Service shall not be construed against the drafting party.
        </p>
        <p className="para-terms">
          SECTION 17 - GOVERNING LAW
          <br />
          These Terms of Service and any separate agreements whereby we provide you Services s
        hall
        ...
        <p className="para-terms">
          ...
          page. We reserve the right, at our sole discretion, to update, change or replace
